...
contract PricingHarberger_Unit_Concrete_Test is PricingHarberger_Unit_Shared_Test {
    ...
    function testIntegratedPriceSimpleMin() public {
        (uint256 simpleMinSpent, uint256 simpleMinPrice) =
            pricingHarberger.getIntegratedPrice(minPrice, 730 days);
    ...
    function testIntegratedPriceSimpleDecay() public {
        (uint256 simpleDecaySpent, uint256 simpleDecayPrice) =
            pricingHarberger.getIntegratedPrice(1 ether, 730 days);
    ...
    function testIntegratedPriceSimpleDecay2() public {
        (uint256 simpleDecaySpent2, uint256 simpleDecayPrice2) =
            pricingHarberger.getIntegratedPrice(1 ether, 209520648);
    ...
    function testIntegratedPriceSimpleMax() public {
        (uint256 simpleMaxSpent, uint256 simpleMaxPrice) =
            pricingHarberger.getIntegratedPrice(1 ether, 365 days);
    ...
    function testIntegratedPriceMaxToMinRange() public {
        (uint256 maxToMinSpent, uint256 maxToMinPrice) =
            pricingHarberger.getIntegratedPrice(0.025 ether, 730 days);
