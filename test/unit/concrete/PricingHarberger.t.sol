...
contract PricingHarberger_Unit_Concrete_Test is PricingHarberger_Unit_Shared_Test {
    ...
    function testIntegratedPriceSimpleMin() public {
        (uint256 simpleMinSpent, uint256 simpleMinPrice) =
            pricingHarberger.getIntegratedPrice(minPrice, 730 days, secondsAfterCreation);
    ...
    function testIntegratedPriceSimpleDecay() public {
        (uint256 simpleDecaySpent, uint256 simpleDecayPrice) =
            pricingHarberger.getIntegratedPrice(1 ether, 730 days, secondsAfterCreation);
    ...
    function testIntegratedPriceSimpleDecay2() public {
        (uint256 simpleDecaySpent2, uint256 simpleDecayPrice2) =
            pricingHarberger.getIntegratedPrice(1 ether, 209520648, secondsAfterCreation);
    ...
    function testIntegratedPriceComplexDecay() public {
        (uint256 complexDecaySpent, uint256 complexDecayPrice) =
            pricingHarberger.getIntegratedPrice(1 ether, 10 * 365 days, secondsAfterCreation);
    ...
    function testIntegratedPriceSimpleMax() public {
        (uint256 simpleMaxSpent, uint256 simpleMaxPrice) =
            pricingHarberger.getIntegratedPrice(1 ether, 365 days, 365 days);
    ...
    function testIntegratedPriceMaxToMiddleRange() public {
        (uint256 maxToMiddleSpent, uint256 maxToMiddlePrice) =
            pricingHarberger.getIntegratedPrice(0.025 ether, 365 days, 365 days);
    ...
    function testIntegratedPriceMaxToMinRange() public {
        (uint256 maxToMinSpent, uint256 maxToMinPrice) =
            pricingHarberger.getIntegratedPrice(0.025 ether, 730 days, 730 days);
        ...
        (maxToMinSpent, maxToMinPrice) = pricingHarberger.getIntegratedPrice(0.025 ether, 3 * 365 days, 3 * 365 days);
