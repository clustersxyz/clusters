...
contract Inbound_Endpoint_setWalletName_Unit_Concrete_Test is Inbound_Harberger_Shared_Test {
    ...
    function testSetWalletName() public {
        ...
        bytes memory data = abi.encodeWithSignature(
            "setWalletName(bytes32,bytes32,string)",
        ...
        assertWalletName(1, 1, _addressToBytes32(users.alicePrimary), "Primary");
    }
}
