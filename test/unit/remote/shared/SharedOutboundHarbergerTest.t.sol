...
import {MessagingFee} from "layerzero-oapp/contracts/oapp-upgradeable/OAppUpgradeable.sol";

abstract contract Outbound_Harberger_Shared_Test is Base_Test {
    ...
    function setUp() public virtual override {
        ...
        Endpoint(endpointGroup.at(0)).setDstEid(2);
        vm.stopPrank();
