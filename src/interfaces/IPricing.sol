...
interface IPricing {
    ...
    function getIntegratedPrice(uint256 _lastUpdatedPrice, uint256 _secondsAfterUpdate, uint256 _secondsAfterCreation)
        external
        view
    ...
    function getIntegratedDecayPrice(uint256 _p0, uint256 _numSeconds)
        external
        pure
        returns (uint256 integratedDecayPrice);
    ...
    function getPriceAfterBid(uint256 _p0, uint256 _pBid, uint256 _bidLengthInSeconds)
        external
        pure
